  ...
  return (
    ...
    >
      ...
      <div className="flex items-center justify-between">
        ...
        >
          Día {status.dayInCycle} de {status.cycleLength}
        </span>
      </div>
